...
Note: To get A* to finish and return an answer (due to runtime limits), 
        you need to first generate a partially completed board with beam search and give that to A* as a 
        starting board. Do this by calling beamStack.getSmallerBoard(board, verbosity)
